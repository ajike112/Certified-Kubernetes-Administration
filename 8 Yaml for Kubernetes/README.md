...
**1. Scalars**
  ...
  - **Example:**
    ```yaml
    first_name: Adekunle # String scalar
...
address:       # Dictionary
  ...
  contact: # Nested dictionary
    ...
    email: adekunle@example.com # String scalar
hobbies:      # List
...
education:    # **Dictionary with Nested List**
  degrees:
    - degree: Bachelors # String scalar
      field: Chemical  Engineering # String scalar
    - degree: Masters # String scalar
      field: General Engineering # String scalar
